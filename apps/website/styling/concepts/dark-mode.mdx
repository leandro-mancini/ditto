...
O Ditto fornece um conjunto de tokens semânticos que você pode usar para estilizar componentes no modo escuro. Saiba mais sobre [tokens semânticos](#).
...
> Siga este guia do `next-themes` para saber mais sobre [forçar o modo de cor](#).
